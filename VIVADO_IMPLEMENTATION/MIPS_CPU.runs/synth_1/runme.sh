...
HD_PWD='C:/Users/chuck/OneDrive/Desktop/ENG442/MIPS_CPU/MIPS_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SingleCycleDataPath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SingleCycleDataPath.tcl
